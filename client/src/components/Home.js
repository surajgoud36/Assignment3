...
function Home() {
    ...
    const updateUser=()=>{
        Axios.put(`http://3.89.93.76:9000/updateUser/${localStorage.getItem("token")}`,{
            name,
            bio,
            username,
            password,
...
<Container className='mt-4 text-center'>
    <Row>
        ...
        <Button variant="primary" onClick={updateUser}>{record && <p>{localStorage.getItem("token")}</p>}</Button>
        </Col>
    </Row>
</Container>
            </>}
